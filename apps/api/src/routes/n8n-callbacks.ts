...
7. Write like a human who genuinely cares that this person is losing — not a brand. Use "I" or "we", be direct, be urgent.${contentCalendar ? `\n\nCONTENT CALENDAR CONTEXT (draw topics and pillars from this):\n${contentCalendar.substring(0, 3000)}` : ''}`
    ...
    const message = await anthropic.messages.create({
      ...
      messages: [{
        role: 'user',
        content: `${userMessage}.\n\nPlatforms: ${platformList.join(', ')}.\n\nReturn a single JSON object with keys for each platform. Each value must be an object with:\n- content: the full post text ready to copy-paste\n- hashtags: array of hashtag strings (with # prefix)\n- image_prompt: A prompt for AI image generation that pairs with this post.\n\nIMAGE PROMPT RULES (STRICT — follow every single one):\n1. ABSOLUTELY NO TEXT, WORDS, LETTERS, NUMBERS, OR WRITING of any kind in the image. Never include text overlays, captions, titles, quotes, watermarks, logos with text, or any written characters. This is the #1 rule.\n2. THE PERSON IS THE HERO: Every image must feature professionals as the clear focal point. Confident, focused people in smart business attire collaborating, making decisions, or working with purpose.\n3. Style: hyper-realistic cinematic scene captured through a high-end DSLR on a tripod. Premium editorial aesthetic like a GQ or Forbes photo shoot.\n4. Lighting: dark, moody lighting with soft shadows and cool undertones. Dramatic contrast. NOT bright or airy — think dimly lit premium office with carefully placed light sources creating depth.\n5. Composition: depth-of-field bokeh, crisp lens reflections, dramatic contrast. Slightly darker tone overall. Shoot with shallow DOF to isolate subjects.\n6. Color palette: cool undertones — deep blues, charcoal grays, subtle steel tones. Desaturated with occasional warm accent from a desk lamp or screen glow. Slightly darker tone overall.\n7. Subjects: professionals in smart business attire, focused and confident. Collaborating around sleek desk setups, working on laptops, having intense discussions, or standing with authority.\n8. Settings: modern premium workplaces — glass-walled offices, sleek conference rooms, minimalist desks with ambient lighting, city views through floor-to-ceiling windows at night or dusk.\n9. NEVER: text overlays, infographics, charts, diagrams, illustrations, cartoons, AI-looking renders, stock photo watermarks, collages, split screens, empty rooms without people, bright/airy aesthetics.\n\nOnly include the platforms listed. Return valid JSON only, no markdown code blocks.`
      }]
    })
