...
export default function CallsPage() {
  ...
  }, [session, direction, fromDate, toDate, search, apptOnly])
  ...
  function exportCsv() {
    const headers = ['Date/Time', 'Direction', 'From', 'To', 'Duration (s)', 'Caller', 'Intent', 'Appt Booked', 'Summary']
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-gray-900 dark:text-white">All Calls</h1>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
                    {['Date / Time', 'Direction', 'From', 'To', 'Duration', 'Caller', 'Intent', 'Outcome'].map(h => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold ${
                          ...
                          {call.direction === 'INBOUND' ? '↙' : '↗'} {call.direction === 'INBOUND' ? 'Inbound' : 'Outbound'}
                        </span>
                      </td>
                      <td className="px-5 py-4 text-xs text-gray-500 dark:text-gray-400 font-mono">{call.fromNumber || '—'}</td>
                      <td className="px-5 py-4 text-xs text-gray-500 dark:text-gray-400 font-mono">{call.toNumber || '—'}</td>
                      ...
                      <td className="px-5 py-4 text-sm text-gray-500 dark:text-gray-400 max-w-40 truncate">
                        {call.intent || '—'}
                      </td>
                      <td className="px-5 py-4">
