...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    objects: [
      ...
      { type: 'textbox', left: 37, top: 33, width: 26, text: '$797', fontSize: 42, fontFamily: 'Arial Black', fontWeight: 'bold', fill: '#FFFFFF', textAlign: 'center' },
      ...
      { type: 'textbox', left: 70, top: 31, width: 25, text: '$1,497', fontSize: 42, fontFamily: 'Arial Black', fontWeight: 'bold', fill: '#FFFFFF', textAlign: 'center' },
